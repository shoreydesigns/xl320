...
//time.mill
//time that it is out of sync
// delta of last current goal and new current goal
// delta of last pos and current pos
...
//Serial.println(Slave_goal_position );
  ...
  for (int i = 0; i > -1; i = i + x) {
    ...
    if ( i>5000)
    {
      packetHandler->write1ByteTxRx(portHandler, MASTER_ID, ADDR_LED, 0);// Purple LED
    }
    else
    {
       packetHandler->write1ByteTxRx(portHandler, MASTER_ID, ADDR_LED, 4);// Purple LED
    }
